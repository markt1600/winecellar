...
export function targetStatus(value,low,high) {
  if(![value,low,high].every(Number.isFinite)||low>=high)return null;
  return value<low?'Below target':value>high?'Above target':null;
}
