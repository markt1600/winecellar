...
export default function SessionGate(){
  ...
  return <section className="gate"><h2>Private camera recordings</h2><p>Temperature and humidity readings are public. Sign in with your marktan.ai Google owner account to view camera recordings and reset monitoring.</p><a className="button" href="https://marktan.ai" target="_blank" rel="noopener">Continue at marktan.ai ↗</a><p className="muted">Already signed in? Open marktan.ai in this same browser to refresh your shared session, then return here. This page checks automatically.</p></section>;
}
