...
export async function POST(request){
 ...
 try{
  const d=await readState(devicePath);await writeState(devicePath,{bootId:b.bootId,ready:b.ready,cameraReady:b.cameraReady===true,cameraPaused:b.cameraPaused===true,shutdownReady:b.shutdownReady===true,seenAt:new Date().toISOString()},d.etag);
