export default function CameraHealth({camera,now}){
 ...
 const labels={paused:'Paused by you',watching:'Watching for motion',recording:'Recording',storage_full:'Paused - storage limit',stopped:'Stopped',unavailable:'Unavailable'};
